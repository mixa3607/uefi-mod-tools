...
public class BinToolsCommandRegistration
{
    public static void Register(Command parentCommand, IServiceCollection services)
    {
        var command = new Command("bin-tools", "Bin dumps related tools");
    ...
    private static void RegisterRenderCommands(Command parentCommand, IServiceCollection services)
    {
        ...
        {
            return services
                    .AddSingleton<IJsonTypeInfoResolver>(BinToolsJsonSerializerContext.Default)
                    .AddSingleton<BinToolsCommandHandlers>()
                ;
        }
        ...
        // split
        {
            ...
            command.SetAction(opts =>
            {
                ...
                var handler = di.GetRequiredService<BinToolsCommandHandlers>();
                handler.SplitBin(
